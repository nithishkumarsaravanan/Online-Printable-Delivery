...
<body class="home">
        ...
        <section class="hero bg-image" data-image-src="images/img/bgimg.jpg">
                ...
                <div class="container text-center hero-text font-white">
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span style="color:white;">1. </span>Choose store</h4> </div>
                        ...
                        <div class="step-item step2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewbox="0 0 380.721 380.721">
                                <g fill="#FFF">
                                    ...
                                    <image href="./images/layers.png" width="380.721" height="380.721" />
                                </svg>
                            <h4><span style="color:white;">2. </span>Order Product</h4> </div>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    ...
                    <p class="lead">Easiest way to order your favourite Product among these top 6 Products</p>
                </div>
                <div class="row">
						<?php 					
                    ...
                    <div class="row how-it-works-solution">
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <p>We"ve got your covered with products from a variety of delivery Stores online.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <p>We"ve got your covered with a variety of delivery Stores online.</p>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <p>Get your Product delivered! And enjoy your Product! </p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="restaurant-listing">
						...
						<?php  
						$ress= mysqli_query($db,"select * from stores");  
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                                ...
                                <div class="col-xs-12 col-sm-5 additional-info color-gray">
                                   ...
                                   <p>Join thousands of other Stores who benefit from having partnered with us.</p>
                                </div>
                    </div>
                </div>
