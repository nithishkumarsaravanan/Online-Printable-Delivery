            ...
            <div class="container text-center hero-text font-white">
                ...
                <div class="steps">
                    <div class="step-item step1">
                        ...
                        <h4><span style="color:white;">1. </span>Choose store</h4>
                    </div>
    ...
    <section class="popular">
        <div class="container">
            <div class="title text-xs-center m-b-30">
                <h2>Prints You Need, Delivered Fast</h2>
                <p class="lead">From homework to photo frames – get your prints at your doorstep in just a few clicks.</p>

            </div>
            <div class="row">
                <?php
                $query_res = mysqli_query($db, "select * from print_photo LIMIT 6");
